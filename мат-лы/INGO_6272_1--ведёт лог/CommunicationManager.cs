...
//------------------------------------------------БОЛЬШАЯ ПОСЫЛКА 106 БАЙТ---------------------------------------------------------------
                           ...
                           /*              if (Char.IsDigit(mmsg[38]))//проверка на цифирность
                               ...
                               /*          if ((mark == 0) | (mark == 1)) { tte_11 = " /////"; };
                                         ...
                                         s = mmsg.Substring(1, 2);//----------идентификатор сообшения
                                         if (Char.IsDigit(s[1]))//проверка на цифирность
                                         {
                                             a = Convert.ToInt32(s);
                                             tte_1 = a.ToString();//Длина базы
                                         }
                                         else
                                         {
                                             tte_1 = s;
                                         ...
                                         s = mmsg.Substring(3, 1);//---------идентификатор устройства
                                         if (Char.IsDigit(s[0]))//проверка на цифирность
                                         {
                                             a = Convert.ToInt32(s);
                                             tte_2 = a.ToString();
                                         }
                                         ...
                                         s = mmsg.Substring(4, 5);//------------версия ПО
                                         if (Char.IsDigit(s[4]))//проверка на цифирность
                                         {
                                             a = Convert.ToInt32(s);
                                             tte_8 = a.ToString();
                                         }
                                         ...
                                         s = mmsg.Substring(12, 1);//---------кодировка состояния обнаружения 
                                         if (Char.IsDigit(s[0]))//проверка на цифирность
                                         {
                                             a = Convert.ToInt32(s);
                                             tte_9 = a.ToString();
                                         ...
                                         s = mmsg.Substring(13, 1);//---------предупреждения
                                         if (Char.IsDigit(s[0]))//проверка на цифирность
                                         {
                                             a = Convert.ToInt32(s);
                                             tte_10 = a.ToString();
                                         ...
                                         s = mmsg.Substring(15, 5);//--------высота 1-го слоя
                                         if (Char.IsDigit(s[4]))//проверка на цифирность
                                         {
                                             a = Convert.ToInt32(s);
                                             tte_11 = a.ToString();
                                         ...
                                         s = mmsg.Substring(21, 5);//---------высота 2-го слоя
                                         if (Char.IsDigit(s[4]))//проверка на цифирность
                                         {
                                             a = Convert.ToInt32(s);
                                             tte_12 = a.ToString();
                                         ...
                                         s = mmsg.Substring(27, 5);//---------высота 3-его слоя
                                         if (Char.IsDigit(s[4]))//проверка на цифирность
                                         {
                                             a = Convert.ToInt32(s);
                                             tte_24 = a.ToString();
                                         ...
                                         s = mmsg.Substring(32, 12);//--------------состояние датчика
                                         if (Char.IsDigit(s[11]))//проверка на цифирность
                                         {
                                             a = Convert.ToInt32(s);
                                             tte_33 = a.ToString();//Длина базы
                                         }
                                         else
                                         {
                                             tte_33 = s;
