...
namespace PCComm
{
  ...
  //      string InputData = String.Empty;
   ...
   /*    public void DisplayData_3(MessageType type, string msg)
        ...
        {
            flag_priema = 1;      //--блокировал слип здесь 14.10.2020
...
//------------------------------------------------БОЛЬШАЯ ПОСЫЛКА 106 БАЙТ---------------------------------------------------------------
                                         ...
                                         {//-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог-----Лог
                                             try
                                             {
                                                 ...
                                                 logger.Debug(mmsg);
                                                 GC.Collect(1);//-добавил тут,а то обратил внимание на размер памяти при работе и ошалел в начале
                                             }                //-14.10.2020 добавил в скобках 1,то есть должен убрать элементы пережившие одну уборку мусора  
                                             catch (Exception ex)
                                             {
